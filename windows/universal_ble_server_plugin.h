...
class UniversalBleServerPlugin : public flutter::Plugin {
 ...
 private:
  ...
  std::unique_ptr<flutter::EventChannel<flutter::EncodableValue>> write_channel_;
  ...
  std::unordered_map<winrt::guid, winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::GattLocalCharacteristic> characteristics;
};
